...
struct JNIAMediaCodecFields {
    ...
    jfieldID buffer_flag_muxer_data_id;
...
static const struct FFJniField jni_amediacodec_mapping[] = {
    { "android/media/MediaCodec", NULL, NULL, FF_JNI_CLASS, offsetof(struct JNIAMediaCodecFields, mediacodec_class), 1 },
        ...
        { "android/media/MediaCodec", "BUFFER_FLAG_PARTIAL_FRAME", "I", FF_JNI_STATIC_FIELD, offsetof(struct JNIAMediaCodecFields, buffer_flag_partial_frame_id), 0 },
        { "android/media/MediaCodec", "BUFFER_FLAG_MUXER_DATA", "I", FF_JNI_STATIC_FIELD, offsetof(struct JNIAMediaCodecFields, buffer_flag_muxer_data_id), 0 },
...
static int codec_init_static_fields(FFAMediaCodec *codec)
{
    ...
    if (codec->jfields.buffer_flag_muxer_data_id) {
        codec->BUFFER_FLAG_MUXER_DATA = (*env)->GetStaticIntField(env, codec->jfields.mediacodec_class, codec->jfields.buffer_flag_muxer_data_id);
        if ((ret = ff_jni_exception_check(env, 1, codec)) < 0) {
            goto fail;
        }
    }
...
int ff_AMediaCodec_getBufferFlagPartialFrame(FFAMediaCodec *codec)
{
    return codec->BUFFER_FLAG_PARTIAL_FRAME;
}

int ff_AMediaCodec_getBufferFlagMuxerData(FFAMediaCodec *codec)
{
    return codec->BUFFER_FLAG_MUXER_DATA;
}
